...
def translate_forward(translator, input):
    ...
    # traducción   
    output = translator(input, src_lang=input_lang, tgt_lang="es_XX")[0]["translation_text"]
...
def translate_backwards(translator, input, language):
    ...
    # traducción   
    output = translator(input, src_lang="es_XX", tgt_lang=language)[0]["translation_text"]
